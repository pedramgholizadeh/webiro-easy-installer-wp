...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Webiro_Theme_Easy_8788448b1a4b4ed09002_20230307001151_archive.zip';
        const ARCHIVE_SIZE       = '45090404';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '8788448-07001151';
        const SECONDARY_PACKAGE_HASH = '734aa6d-07001151';
